...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "drawSubImage Test", width : 1024, height : 768, samplesPerPixel : 4},function() {
		new Main();
	});
};
Main.prototype = {
...
var gridSheet_GridSheet = function(gi) {
	this.totalCount = 8;
	this.count = 0;
	this.c = 0;
	this.r = 0;
...
var kha__$Assets_ImageList = function() {
	this.names = ["colorGrid","unicorn"];
	this.unicornDescription = { files : ["unicorn.png"], original_height : 80, type : "image", original_width : 1056, name : "unicorn"};
	this.unicornName = "unicorn";
	this.unicorn = null;
	this.colorGridDescription = { files : ["colorGrid.png"], original_height : 400, type : "image", original_width : 550, name : "colorGrid"};
	this.colorGridName = "colorGrid";
	this.colorGrid = null;
};
...
kha__$Assets_ImageList.prototype = {
	colorGrid: null
	,colorGridName: null
	,colorGridDescription: null
	,colorGridLoad: function(done) {
		kha_Assets.loadImage("colorGrid",function(image) {
			done();
		});
	}
	,colorGridUnload: function() {
		this.colorGrid.unload();
		this.colorGrid = null;
	}
	,unicorn: null
	,unicornName: null
	,unicornDescription: null
	,unicornLoad: function(done) {
		kha_Assets.loadImage("unicorn",function(image) {
			done();
		});
	}
	,unicornUnload: function() {
		this.unicorn.unload();
		this.unicorn = null;
	}
	,names: null
